...
class OrdersControllerTest < ActionDispatch::IntegrationTest
  setup do
    ...
    @order = Order.create(user_id: @user.id, subtotal: 10, tax: 1, total: 11)
  ...
  test "show" do
    ...
    data = JSON.parse(response.body)
    assert_equal ["id", "user_id", "subtotal", "tax", "total", "carted_products", "created_at", "updated_at"], data.keys
  end
end
